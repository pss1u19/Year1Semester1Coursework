class GUITrainer extends Teacher {
    ...
    */
    GUITrainer(String givenName, char givenGender, int givenAge) throws Exception {
    ...
    boolean canTeach(Subject subject) {
        if (subject.getSpecialism() == 1 || subject.getSpecialism() == 2 || subject.getSpecialism() == 4) return true;
        else return false;
    }
